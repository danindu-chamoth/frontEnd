...
export default function AdminEditProductFrom() {
    ...
    const altName = product.altNames.join(",");

    if(product==null){
        navigate("/admin/Product");
    }

    const [productId, setProductsID] = useState(product.productId);
    const [productName, setProductName] = useState( product.productName);
    const [altNames, setAltNames] = useState(altName);
    const [imageFiles, setImageFiles] = useState([]);
    const [price, setPrice] = useState( product.price);
    const [lastPrice, setLastPrice] = useState( product.lastPrice);
    const [stock, setStock] = useState( product.stoke);
        ...
        <div className="p-4">
            <div className="bg-white rounded border max-w-4xl mx-auto">
                <div className="bg-blue-500 text-white p-4">
                    ...
                    <p className="text-center mt-1">Fill in the details to Edit product</p>
                </div>
